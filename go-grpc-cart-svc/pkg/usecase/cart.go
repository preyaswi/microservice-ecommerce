...
import (
	...
	clientinterface "github.com/preyaswi/grpc-cart-svc/pkg/client/interface"
	interfaces "github.com/preyaswi/grpc-cart-svc/pkg/repository/interface"
	services "github.com/preyaswi/grpc-cart-svc/pkg/usecase/interface"
	"github.com/preyaswi/grpc-cart-svc/pkg/utils/models"
)

type cartUseCase struct {
	cartRepository    interfaces.CartRepository
	productRepository clientinterface.NewProductClient
}

func NewCartUseCase(repository interfaces.CartRepository, productRepo clientinterface.NewProductClient) services.CartUseCase {
